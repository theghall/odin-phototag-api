...
class PhotoAPIQueryTest < ActionDispatch::IntegrationTest
  ...
  test "it should return all fields" do
    ...
    assert_equal "1,2", json_resp[0]["items"][0]["locations"][0]["bottom_left_loc"]
    assert_equal "1,3", json_resp[0]["items"][0]["locations"][0]["top_left_loc"]
    assert_equal "3,4", json_resp[0]["items"][0]["locations"][0]["top_right_loc"]
    assert_equal "1,4", json_resp[0]["items"][0]["locations"][0]["bottom_right_loc"]
